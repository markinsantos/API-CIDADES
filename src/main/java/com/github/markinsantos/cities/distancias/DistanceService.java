package com.github.markinsantos.cities.distancias;
...
public class DistanceService {
  ...
  public DistanceService(final CitiesRepository cityRepository) {
  ...
  public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
    ...
    final List<Cities> cities = cityRepository.findAllById((Arrays.asList(city1, city2)));
